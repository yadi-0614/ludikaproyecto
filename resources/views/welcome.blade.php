...
<body
    ...
    <footer style="
        ...
        <a href="{{ url('/') }}" style="display:inline-flex;align-items:center;gap:8px;text-decoration:none;">
            <span
                style="width:26px;height:26px;background:#C9A227;border-radius:7px;display:flex;align-items:center;justify-content:center;">
            ...
            <span style="font-size:0.95rem;font-weight:800;color:#EAD8B1;letter-spacing:0.5px;">Lúdika</span>
        </a>
        <p style="color:rgba(234,216,177,0.9);font-size:0.85rem;margin:0;font-weight:600;">
